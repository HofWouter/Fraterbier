...
<?php
    ...
    if ($current_lang == 'dk') {
        $benieuwd_naar_meer = 'Nysgerrig efter mere?';
    }
    else if ($current_lang == 'en') {
        $benieuwd_naar_meer = 'Curious about more?';
    }

    else if ($current_lang == 'nl') {
        $benieuwd_naar_meer = 'Benieuwd naar meer?';
    }
...
<main>
    ...
    if ( have_posts() ) {
        while( have_posts() ){
            the_post();
            ?>
        <section class="waar-te-koop--accent section--accent section section--first">
            ...
            <div class="section__title post__title">
                <h1 class="title--secondary"><?php echo ($benieuwd_naar_meer); ?></h1>
            </div>
            <div>
                <?php
            ...
            <div>
            <?php echo do_shortcode('[contact-form-7 id="61c940d" title="Contactformulier" html_class="form__group"]'); ?>
            </div>
            </div>
            </div>
        </section>     
		...
		<section class="section--accent section">
			<div class="header__wrapper">
				...
				<p>Er zijn geen berichten om weer te geven.</p>
			</div>
		</section>
		<?php
	}
