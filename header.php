...
<body <?php body_class(); ?>>
        ...
        <nav>
            ...
            <button class="nav-btn" id="language-btn">
                ...
                <img src="<?php echo get_template_directory_uri(); ?>/assets/arrow_dropdown.svg">
            </button>     
            </div>
